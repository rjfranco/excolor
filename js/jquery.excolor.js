...
(function() {
  ...
  jQuery.fn.excolor = function(C) {
    ...
    return this.each(function() {
      var A, B, action_exit, action_ok, aitem, aitem_pos, backlight, brightness, click_flag, click_to, close_but, colsample, correct_x, correct_y, draw_rgb, hex2rgb, hex_valid_and_draw, hexto, hsb2rgb_hex, hue, huebox, i, init_color, init_colors, init_positions, inp_b, inp_g, inp_hex, inp_r, inputhex, isample, j, k, l, looper, m, moved_slider, n, o, ok_but, opened, p, parsergb, parsex, pos_huebox, pos_sel, pos_slider, pos_wrap, q, rad3px, radwrap, rgb2hex, rgb2hsv, rgb_input, rgb_output, root_path, run_excolor_colorpicker, saturation, sb_sel, sbbox, shadow, slider, switcher, t, u, update_inputs, userok, w, wrapper, y, z;
      init_color = function() {
        var brightness, hue, i, inputhex, parsex, rgb_output, rgbstring, saturation;
        ...
        if (parsex === "") {
          ...
          if (parsex.match(rgb_input)) {
            ...
            while (i < parsex.length) {
              if (parsex.charAt(i) !== "#" && (parsex.charAt(i) + "") in y ? inputhex.length < 6 : void 0) {
        ...
        if (C.show_color_on_border) {
          return jQuery(aitem).css("border-color", "#" + inputhex);
        }
      };
      action_exit = function() {
        var click_flag, opened;
        if (!opened) {
          return false;
        }
      ...
      action_ok = function() {
        ...
        if (userok) {
          ...
          return C.callback_on_ok();
        }
      };
      draw_rgb = function() {
        var a, brightness, hue, saturation;
        ...
        init_positions();
        init_colors();
        return jQuery(inp_hex).val(rgb2hex(jQuery(inp_r).val() * 1, jQuery(inp_g).val() * 1, jQuery(inp_b).val() * 1));
      };
      hex_valid_and_draw = function() {
        var a, b, brightness, hexistr, hue, i, saturation;
        a = true;
        hexistr = "";
        ...
        if (a) {
          ...
          if (hexistr === "") {
            ...
            return jQuery(wrapper).find("input").val("");
          }
        }
      };
      update_inputs = function() {
        ...
        return jQuery(inp_hex).val(rgb2hex(a["r"], a["g"], a["b"]));
      };
      hsb2rgb_hex = function(a, b, c, d) {
        var e, f, h, s, v, var_1, var_2, var_3, var_b, var_g, var_i, var_r;
        h = a / 360;
        s = b / 100;
        v = c / 100;
        e = new Array();
      ...
      init_positions = function() {
        jQuery(slider).css("left", pos_huebox.left + "px").css("top", (pos_huebox.top + hue) + "px");
        return jQuery(sb_sel).css("left", (pos_sbbox.left + Math.round(saturation * 1.3) - 4) + "px").css("top", (pos_sbbox.top + jQuery(sbbox).height() - 4 - Math.round(brightness * 1.3)) + "px");
      };
      init_colors = function() {
        ...
        return jQuery(switcher).css("background", "url(" + root_path + "transp0.gif) 0 0 no-repeat");
      };
      run_excolor_colorpicker = function() {
        var aitem_pos, b, c, close_but, colsample, huebox, inp_b, inp_g, inp_hex, inp_r, ok_but, opened, pos_huebox, pos_sbbox, pos_wrap, sb_sel, sbbox, slider, switcher, wrapper;
        b = -1 * C.hue_bar * 20;
        ...
        wrapper = jQuery("body > div#excolor_colorpicker").css("left", aitem_pos.left + "px").css("top", (aitem_pos.top + jQuery(aitem).outerHeight()) + "px").mouseenter(function() {
          ...
          return click_to = setTimeout(function() {
            var click_flag;
            return click_flag = true;
          }, 50);
        }).mouseleave(function() {
          var click_to;
          clearTimeout(click_to);
        ...
        switch (C.effect) {
          ...
          case "fade":
            jQuery("body > div#excolor_colorpicker, body > div#excolor_slider, body > div#excolor_picker, body > div#excolor_switcher").fadeTo(1, 0, function() {
              return jQuery(this).show().fadeTo(C.anim_speed, 1);
            });
            break;
          default:
            jQuery(wrapper).show();
        ...
        jQuery(switcher).click(function() {
          if (jQuery.trim(jQuery(inp_r).val()) === "" && jQuery.trim(jQuery(inp_g).val()) === "" && jQuery.trim(jQuery(inp_b).val()) === "") {
            ...
            jQuery(colsample).css("background-image", "url(" + root_path + "transp.gif)").css("background-repeat", "repeat");
            jQuery(wrapper).find("input").val("");
            return jQuery(this).css("background", "url(" + root_path + "transp0.gif) -20px 0 no-repeat");
          }
        ...
        jQuery(sb_sel).mouseenter(function() {
          ...
          return jQuery(ok_but).click();
        });
        jQuery(sb_sel).mousedown(function(e) {
          var correct_x, correct_y, j, pos_sel;
        ...
        jQuery(slider).mousedown(function(e) {
          var correct_x, correct_y, moved_slider, pos_slider;
        ...
        jQuery(huebox).mousedown(function(e) {
          var correct_x, correct_y, hue, moved_slider, pos_slider;
        ...
        jQuery(sbbox).mousedown(function(e) {
          var brightness, correct_x, correct_y, j, pos_sel, saturation;
        ...
        inp_hex[0].onpaste = inp_hex[0].oninput = function(e) {
          var hexto;
          clearTimeout(hexto);
          return hexto = setTimeout(function() {
            return hex_valid_and_draw();
          }, 100);
        };
        ...
        jQuery(ok_but).click(function() {
          ...
          return jQuery(this).css("background-position", "0 -15px");
        }).mouseleave(function() {
          return jQuery(this).css("background-position", "0 0");
        });
        jQuery(close_but).click(function() {
          return action_exit();
        }).mouseenter(function() {
          return jQuery(this).css("background-position", "-47px -15px");
        }).mouseleave(function() {
          return jQuery(this).css("background-position", "-47px 0");
        });
        init_positions();
        ...
        opened = true;
        if (inputhex === "") {
          return jQuery(switcher).css("background", "url(" + root_path + "transp0.gif) -20px 0 no-repeat");
        } else {
          return jQuery(switcher).css("background", "url(" + root_path + "transp0.gif) 0 0 no-repeat");
        }
      };
      ...
      if (C.color_box) {
        jQuery(aitem).wrap("<span style=\"margin:0;padding:0\"></span>");
      }
      u = "";
      rad3px = "";
      radwrap = "";
      ...
      isample = jQuery(aitem).parent().find("#" + A).mouseenter(function() {
        ...
        return jQuery(aitem).focus();
      });
      if (C.color_box) {
        setTimeout((function() {
          return jQuery(isample).show();
        }), 150);
      }
      init_color();
      setTimeout((function() {
        return aitem_pos = jQuery(aitem).offset();
      }), 200);
      jQuery(document).mouseup(function(e) {
        j = "mel";
        return moved_slider = "mel";
      ...
      jQuery(aitem).click(function() {
        if (!opened) {
          ...
          return setTimeout((function() {
            return run_excolor_colorpicker();
          }), 50);
        }
      }).keyup(function() {
        if (opened) {
      ...
      jQuery(isample).click(function() {
        return jQuery(aitem).click();
      });
      if (C.demo_mode) {
        return jQuery(isample).click();
      }
    });
  };
